  ...
  return (
    <main className="px-4">
      ...
      <div className="space-y-4">
        <Alert
          type={"success"}
          content="مرکز لورم لورم، با اعطای نماد دانش بنیان هویت صاحب و فعالیت کسب و کارهای
        این شرکت را احراز می‌نماید. مسئولیت صحت فعالیت کسب و کار بر عهده صاحب
        کسب و کار می باشد. دارنده دانش‌بنیان، تحت نظارت دستگاه های مسئول، ملزم
        به رعایت قوانین و مقررات مندرج در تعهدنامه نماد می باشد."
        />
        <Alert
          type={"success"}
